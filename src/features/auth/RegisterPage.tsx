    ...
    <PageShell>
      <div className="mx-auto flex min-h-[80vh] max-w-lg items-center">
        <div className="w-full rounded-2xl border border-cyan-500/20 bg-slate-900/80 p-6 shadow-2xl backdrop-blur">
          ...
          <p className="mt-1 text-sm text-slate-400">Join your team workspace and start managing work.</p>
          ...
          <form className="mt-6 grid gap-4" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">Backend may override this based on policy.</p>
            </div>
