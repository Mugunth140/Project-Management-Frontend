  ...
  return (
    <SectionCard title={isEditMode ? 'Edit project' : 'Create project'}>
      <form className="grid gap-4 md:grid-cols-2" onSubmit={onSubmit}>
        ...
        <div className="md:col-span-2">
          <label className="mb-1 block text-sm text-zinc-700" htmlFor="description">
            Description
          </label>
        ...
        <div>
          <label className="mb-1 block text-sm text-zinc-700" htmlFor="status">
            Status
          </label>
        ...
        <div>
          <label className="mb-1 block text-sm text-zinc-700" htmlFor="priority">
            Priority
          </label>
        ...
        <div>
          <label className="mb-1 block text-sm text-zinc-700" htmlFor="deadline">
            Deadline
          </label>
